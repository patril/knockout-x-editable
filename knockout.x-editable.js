...
(function (factory) {
    ...
    ko.bindingHandlers.editable = {
        init: function (element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
            ...
            if ((editableOptions.type === 'select' || editableOptions.type === 'select2' || editableOptions.type === 'checklist' || editableOptions.type === 'bstypeahead') && !editableOptions.source && editableOptions.options) {
